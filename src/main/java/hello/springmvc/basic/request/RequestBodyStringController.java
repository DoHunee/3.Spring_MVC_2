...
public class RequestBodyStringController {
    ...
    /**
     * InputStream(Reader): HTTP 요청 메시지 바디의 내용을 직접 조회 OutputStream(Writer): HTTP
     * 응답 메시지의 바디에 직접 결과 출력 
    ...
    /**
     * HttpEntity: HTTP header, body 정보를 편리하게 조회 - 메시지 바디 정보를 직접
     * 조회(@RequestParam X, @ModelAttribute X) - HttpMessageConverter 사용 ->
     * StringHttpMessageConverter 적용
     *
     * 응답에서도 HttpEntity 사용 가능 - 메시지 바디 정보 직접 반환(view 조회X) - HttpMessageConverter
     * 사용 -> StringHttpMessageConverter 적용
