...
public class RequestParamController {
     ...
     *
     * 주의! /request-param-required?username= -> 빈문자로 통과 주의!
     * /request-param-required int age -> null을 int에 입력하는 것은 불가능, 따라서 Integer
     * 변경해야 함(또는 다음에 나오는 defaultValue 사용)
     ...
     * http://localhost:8080/request-param-default?username=hello&age=20
     */
    @ResponseBody
     ...
     * value=[id1,id2])
     * http://localhost:8080/request-param-map?userIds=id1&userIds=id2
     */
    @ResponseBody
    ...
    /**
     * @ModelAttribute 생략 가능 String, int 같은 단순 타입 = @RequestParam argument
     * resolver 로 지정해둔 타입 외 = @ModelAttribute
